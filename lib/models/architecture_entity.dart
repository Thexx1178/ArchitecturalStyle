// lib/models/architecture_entity.dart
class ArchitectureEntity {
  final String name;        // ชื่อสไตล์
  final String era;         // ยุค/ช่วงเวลา
  final String brief;       // คำอธิบายสั้น ๆ
  final List<String> tags;  // คีย์เวิร์ด/ลักษณะเด่น
...
// ── ชุดข้อมูลตั้งต้น (แก้/เพิ่มได้ตามต้องการ)
const List<ArchitectureEntity> kArchitectureEntities = [
  ArchitectureEntity(
